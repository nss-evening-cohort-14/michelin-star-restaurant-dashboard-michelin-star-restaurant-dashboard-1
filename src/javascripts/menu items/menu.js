...
const showUserMenuItems = (array) => {
  ...
  array.forEach((item) => {
    ...
    <div class="media-body">
      ...
      <p>${item.description}</p>
      <p>${item.price}</p>
      <button type="button" class="btn btn-secondary" id="edit-menu-item--${item.firebasekey}">Edit</button>
...
export { showMenuItems, showUserMenuItems };
